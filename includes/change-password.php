    ...
    <form id="buddyforms_password_form" method="POST" action="<?php echo $current_url; ?>">
        <fieldset>
            ...
            <p>
                ...
                <input name="buddyforms_user_pass_confirm" id="buddyforms_user_pass_confirm" class="required"
                       type="password"/>
            </p>
            <p>
                ...
                <input type="hidden" name="buddyforms_password_nonce"
                       value="<?php echo wp_create_nonce( 'buddyforms-password-nonce' ); ?>"/>

            <div><span id="password-strength"></span></div>
            <input id="buddyforms_password_submit" disabled="disabled" type="submit" class="bf-submit"
                   value="<?php _e( 'Change Password', 'buddyforms' ); ?>"/>
