...
if(isset($_POST['deletepost'])) {
	...
	CPT4BP::delete_a_group($_POST['editpost_id'], $_POST['editpost_post_type']);
...
if($deleted == true){
	echo _e('Post successful deleted','cpt4bp');
} else { ?>

<form action="<?php echo $_SERVER['REQUEST_URI']; ?>" id="delete_post" method="POST">

	<p><?php _e('Delete Post','cpt4bp') ?></p>
	...
	<li class="buttons">
		...
		<button type="submit" id="deletepost" class="button"><?php _e('Delete','cpt4bp'); ?></button>
	</li>
</form>
