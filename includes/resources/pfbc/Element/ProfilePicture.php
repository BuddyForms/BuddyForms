...
class Element_ProfilePicture extends Element_Textbox
{
    ...
    function __construct($label, $name, $properties = null)
    {
        add_action( 'buddyforms_process_submission_end',array($this,'profile_picture_user_registration_ended') ,10,1 );
    }

    public function profile_picture_user_registration_ended($args){
   ...
   // protected $_attributes = array("type" => "file","file_limit"=>"","accepted_files"=>"","multiple_files"=>"","delete_files"=>"","description"=>"","mandatory"=>"");
    ...
    function bp_attachments_enqueue_scripts( $class = '' ) {
        ...
        if ( ! empty( $args['bp_params'] ) ) {
            ...
            $defaults['multipart_params']['bp_params'] = array('object'=>'user','item_id'=>1,'has_avatar'=>false,'nonces'=>array('set'=>'4d679f8997'),'ui_available_width'=>498);
        }
