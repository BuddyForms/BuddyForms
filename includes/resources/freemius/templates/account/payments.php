...
if ( $show_payments ) :
    ...
    <div class="postbox">
        <div id="fs_payments">
            <h3>
                <span class="dashicons dashicons-paperclip"></span> <?php fs_esc_html_echo_inline( 'Payments', 'payments', $slug ) ?>
            </h3>
                ...
                <table class="widefat">
					...
					<?php foreach ( $payments as $payment ) : ?>
                        <tr<?php echo $odd ? ' class="alternate"' : '' ?>>
                            ...
                            <td><?php if ( ! $payment->is_migrated() ) : ?><a
                                    href="<?php echo $fs->_get_invoice_api_url( $payment->id ) ?>"
                                    class="button button-small"
                                    target="_blank"><?php fs_esc_html_echo_inline( 'Invoice', 'invoice', $slug ) ?></a><?php endif ?>
                            </td>
                        </tr>
