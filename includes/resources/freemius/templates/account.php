                                        ...
                                        <li>
                                            <form action="<?php echo $fs->_get_admin_page_url( 'account' ) ?>"
												...
												?>'))  this.parentNode.submit(); return false;"><i
                                                            class="dashicons dashicons-no"></i> <?php fs_echo( 'delete-account', $slug ) ?>
                                                </a>
                                            </form>
                                        </li>
                                        <li>&nbsp;&bull;&nbsp;</li>
                                            ...
                                            <li>
                                                <form action="<?php echo $fs->_get_admin_page_url( 'account' ) ?>"
                                                    ...
                                                    <a href="#"
													   ...
													   } ?> <?php fs_echo( 'proceed-confirmation', $slug ) ?>')) this.parentNode.submit(); return false;"><i
                                                                class="dashicons dashicons-download"></i> <?php fs_echo( ( $fs->is_only_premium() ? 'cancel-subscription' : 'downgrade' ), $slug ) ?>
                                                    </a>
                                                </form>
                                            </li>
                                            <li>&nbsp;&bull;&nbsp;</li>
										...
										<?php if ( ! $fs->is_single_plan() ) : ?>
                                            <li>
                                                <a href="<?php echo $fs->get_upgrade_url() ?>"><i
                                                            class="dashicons dashicons-grid-view"></i> <?php fs_echo( 'change-plan', $slug ) ?>
                                                </a>
                                            </li>
                                            <li>&nbsp;&bull;&nbsp;</li>
										<?php endif ?>
                                            ...
                                            <form action="<?php echo $fs->_get_admin_page_url( 'account' ) ?>"
                                                ...
                                                <a href="#"
                                                   onclick="if (confirm('<?php fs_echo( 'cancel-trial-confirm' ) ?>')) this.parentNode.submit(); return false;"><i
                                                            class="dashicons dashicons-download"></i> <?php fs_echo( 'cancel-trial', $slug ) ?>
                                                </a>
                                            </form>
                                        </li>
                                        <li>&nbsp;&bull;&nbsp;</li>
                                    ...
                                    <li>
                                        <form action="<?php echo $fs->_get_admin_page_url( 'account' ) ?>"
                                            ...
                                            <a href="#" onclick="this.parentNode.submit(); return false;"><i
                                                        class="dashicons dashicons-image-rotate"></i> <?php fs_echo( 'sync', $slug ) ?>
                                            </a>
                                        </form>
                                    </li>
														...
														<?php if ( false !== $available_license && ( $available_license->left() > 0 || ( $site->is_localhost() && $available_license->is_free_localhost ) ) ) : ?>
                                                            ...
                                                            <form action="<?php echo $fs->_get_admin_page_url( 'account' ) ?>"
                                                                ...
                                                                <input type="hidden" name="license_id"
                                                                       value="<?php echo $available_license->id ?>">
														...
														<?php else : ?>
                                                            <form action="<?php echo $fs->_get_admin_page_url( 'account' ) ?>"
																...
																<?php if ( $show_upgrade && $fs->is_premium() ) : ?>
                                                                    <a class="button activate-license-trigger <?php echo $slug ?>"
                                                                       href="#"><?php fs_esc_html_echo( 'activate-license', $slug ) ?></a>
																<?php endif ?>
                                                                    ...
                                                                    <a href="<?php echo $fs->get_upgrade_url() ?>"
																	   ...
																	   echo $show_upgrade ?
																		   ...
																		   ' fs-change-plan'; ?> button-upgrade"><i
                                                                                class="dashicons dashicons-cart"></i> <?php fs_esc_html_echo( $show_upgrade ? 'upgrade' : 'change-plan', $slug ) ?>
                                                                    </a>
																<?php endif ?>
                                                            </form>
														<?php endif ?>
                                                ...
                                                <td class="fs-right">
													...
													( is_string( $user->secret_key ) && in_array( $p['id'], array(
                                                        ...
                                                        <form action="<?php echo $fs->_get_admin_page_url( 'account' ) ?>"
                                                            ...
                                                            <input type="hidden"
                                                                   name="fs_<?php echo $p['id'] ?>_<?php echo $slug ?>"
                                                                   value="">
