 ...
 * @since 0.1-beta
 */
class CPT4BP_Groups_Widget extends WP_Widget
{
	/**
	...
	public function __construct() {
		$widget_ops = array(
			'classname'   => 'widget_display_cpt4bp_groups',
			'description' => __( 'A list of groups.', 'cpt4bp' )
		);
		
		parent::__construct( false, __( 'CPT4BP Groups', 'cpt4bp' ), $widget_ops );
	}
	...
	public function widget( $args, $instance ) {
	   	global $post, $group_type, $wp_query, $cpt4bp;
