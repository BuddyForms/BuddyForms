...
function buddyforms_get_addons( $call_api ) { ?>
	...
	<div class="col-12" itemscope="" itemtype="http://schema.org/SoftwareApplication">
		...
		<p style="text-align: right"><strong style="float: left"> Showing <?php echo count( $call_api->plugins ) + 1 ?>
				Extensions </strong>
			<br class="clear"></p>
				...
				<div class="plugin-card plugin-card-<?php echo sanitize_html_class( $plugin['slug'] ); ?>">
					...
					<div class="plugin-card-bottom">
						<div class="vers column-rating">
							...
							<span class="num-ratings">(<?php echo number_format_i18n( $plugin['num_ratings'] ); ?>
								)</span>
						</div>
