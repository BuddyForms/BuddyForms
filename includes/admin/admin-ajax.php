...
function buddyforms_form_template(){
	...
	switch( $_POST['template'] ){
		case 'contact' :
			...
			break;
		case 'registration' :
			$buddyform =  json_decode( '{"form_fields":{"a40912e1a5":{"type":"user_login","slug":"user_login","name":"Username","description":""},"82abe39ed2":{"type":"user_email","slug":"user_email","name":"eMail","description":""},"611dc33cb2":{"type":"user_pass","slug":"user_pass","name":"Password","description":""}},"form_type":"registration","after_submit":"display_message","after_submission_page":"none","after_submission_url":"","after_submit_message_text":"Form Submitted Successfully","post_type":"bf_submissions","status":"publish","comment_status":"open","singular_name":"","attached_page":"none","edit_link":"all","list_posts_option":"list_all_form","list_posts_style":"list","registration":{"activation_page":"none","activation_message_from_subject":"User Account Activation Mail","activation_message_text":"Please click the link to activate yur account. [activation_link]","activation_message_from_name":"[blog_title]","activation_message_from_email":"mail@sven-lehnert.de"},"name":"Registration Form 1","slug":"registration-form-1"}', true );
			break;
		case 'post' :
