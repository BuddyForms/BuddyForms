...
function buddyforms_form_template(){
	...
	switch($_POST['template']){
		case 'contact' :
			...
			break;
		case 'create' :
			$buddyform =  json_decode('{"form_fields":{"bef0fd43e6":{"name":"Name","slug":"name","description":"","type":"text","validation_error_message":"This field is required.","validation_minlength":"0","validation_maxlength":"0","custom_class":""},"2391bf0a50":{"name":"Mail","slug":"mail","description":"","type":"mail","validation_error_message":"This field is required.","custom_class":""},"544d105558":{"name":"Website","slug":"website","description":"","type":"link","validation_error_message":"This field is required.","metabox_enabled":["metabox_enabled"],"custom_class":""},"5bf35b20e3":{"name":"Subject","slug":"editpost_title","description":"","type":"title","validation_error_message":"This field is required.","validation_minlength":"0","validation_maxlength":"","custom_class":""},"a6aa43b61d":{"name":"Content","slug":"editpost_content","description":"","type":"content","validation_error_message":"This field is required.","validation_minlength":"0","validation_maxlength":"0","custom_class":""}},"name":"Test","slug":"test","after_submit":"display_form","after_submit_message_text":"The [form_singular_name] [post_title] has been successfully updated!<br>1. [post_link]<br>2. [edit_link]","singular_name":"","post_type":"post","attached_page":"701","status":"publish","comment_status":"open","edit_link":"all","list_posts_option":"list_all_form","list_posts_style":"list","moderation_logic":"default","moderation":{"label_submit":"Submit","label_save":"Save","label_review":"Submit for moderation","label_new_draft":"Create new Draft","label_no_edit":"This Post is waiting for approval and can not be changed until it gets approved"}}', true);
			break;
	}
