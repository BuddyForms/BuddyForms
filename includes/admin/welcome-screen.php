 ...
 *
 * since 2.5.9 The Info menu option was moved to the a Setting tab
 */
add_action( 'buddyforms_settings_page_tab', 'buddyforms_welcome_screen_content', 10, 1 );

function buddyforms_welcome_screen_content( $tab ) {
	if ( $tab === 'info' ) {
		?>
        <div id="bf_admin_wrap" class="wrap">
            ...
            <style>
                ...
                #poststuff .about-wrap.buddyforms-welcome {
                    margin-top: 40px;
                }

                #poststuff .about-wrap.buddyforms-welcome .lead {
                    max-width: none;
                    margin: 20px 0;
                }

                #poststuff .about-wrap.buddyforms-welcome .feature-section h1 {
                    max-width: none;
                    margin: 40px 0 20px;
                    font-weight: 300;
                }

                #poststuff .about-wrap.buddyforms-welcome h2 {
                    max-width: none;
                    font-size: 2.7em;
                    margin: 40px 0 20px;
                    text-align: left;
                ...
                #poststuff .about-wrap.buddyforms-welcome .about-text {
                    min-height: 40px;
                    margin-top: 20px;
                    font-size: 23px;
                    color: #32373c;
                ...
                #poststuff .about-wrap.buddyforms-welcome .bfw-title {
                    margin-top: 0;
                    font-weight: 300;
                }
            </style>
