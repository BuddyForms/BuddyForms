...
function buddyforms_welcome_screen_content() {
	...
	<div id="bf_admin_wrap" class="wrap">
		...
		<div class="wrap about-wrap buddyforms-welcome">
			<h1><?php esc_html_e( 'Welcome to BuddyForms', 'buddyforms' ); ?> <?php echo esc_html( BUDDYFORMS_VERSION ); ?></h1>
		</div>
								...
								">
									...
									<?php } else { ?>
										<button <?php echo esc_attr( $disabled ); ?> id="btn-add-new-<?php echo esc_attr( $key ); ?>"
																		...
																		onclick="document.location.href='<?php echo esc_url( self_admin_url( 'post-new.php?post_type=buddyforms&template=' . esc_html( $key ) ) ); ?>'">
											<?php esc_html_e( 'Use This Template', 'buddyforms' ); ?>
										</button>
									<?php } ?>
									<div id="template-<?php echo esc_html( $key ); ?>" style="display:none;">
			...
			<div class="bf-welcome-accordion">
				...
				<div class="bf-welcome-accordion_content">
					<div class="bf-welcome-accordion_item">
						...
						<img style="width:650px;" src="<?php echo esc_url( BUDDYFORMS_ASSETS ); ?>admin/img/welcome-screen/gutenberg-form.gif" alt="">
					</div>
					...
					<div class="bf-welcome-accordion_item">
						...
						<img style="width:650px;" src="<?php echo esc_url( BUDDYFORMS_ASSETS ); ?>admin/img/welcome-screen/gutenberg-list-submissions.gif" alt="">
					</div>
					...
					<div class="bf-welcome-accordion_item">
						...
						<img style="width:650px;" src="<?php echo esc_url( BUDDYFORMS_ASSETS ); ?>admin/img/welcome-screen/gutenberg-add-navigation.gif" alt="">
					</div>

					<div class="bf-welcome-accordion_item">
						<p class="item_title">Login/ Logout Form</p>
						<p>Display a login form or a logout button if the user is logged in.</p>
						<img style="width:650px;" src="<?php echo esc_url( BUDDYFORMS_ASSETS ); ?>admin/img/welcome-screen/gutenberg-login-form.gif" alt="">
					</div>
			...
			?>
				<script>
					jQuery( document ).ready(function() {
						jQuery("#btn-compile-<?php echo esc_html( $template ); ?>").click();
					});
				</script>
			<?php
		}
