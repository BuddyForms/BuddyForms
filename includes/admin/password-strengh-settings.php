					...
					<table class="form-table">
						...
						<tr valign="top">
							...
							<td class="forminp forminp-text">
								<input name="buddyforms_password_strength_settings[lavel_1]" id="buddyforms_password_strength_lavel_1" type="text" style="min-width:350px;" value="<?php echo isset( $password_strength_settings['lavel_1'] ) && ! empty( $password_strength_settings['lavel_1'] ) ? esc_attr( $password_strength_settings['lavel_1'] ) : esc_attr__( 'Short: Your password is too short.', 'buddyforms' ); ?>" class="" placeholder="<?php esc_attr_e( 'Short: Your password is too short.', 'buddyforms' ); ?>">
							</td>
						</tr>
						<tr valign="top">
							<th scope="row" class="titledesc">
						...
						<tr valign="top">
							...
							<td class="forminp forminp-text">
								<input name="buddyforms_password_strength_settings[lavel_3]" id="buddyforms_password_strength_lavel_3" type="text" style="min-width:350px;" value="<?php echo isset( $password_strength_settings['lavel_3'] ) && ! empty( $password_strength_settings['lavel_3'] ) ? esc_attr( $password_strength_settings['lavel_3'] ) : esc_attr__( 'Password Strength: OK', 'buddyforms' ); ?>" class="" placeholder="<?php esc_attr_e( 'Password Strength: OK', 'buddyforms' ); ?>">
							</td>
						</tr>
						<tr valign="top">
							<th scope="row" class="titledesc">
							...
							<td class="forminp forminp-text">
								<input name="buddyforms_password_strength_settings[lavel_4]" id="buddyforms_password_strength_lavel_4" type="text" style="min-width:350px;" value="<?php echo isset( $password_strength_settings['lavel_4'] ) && ! empty( $password_strength_settings['lavel_4'] ) ? esc_attr( $password_strength_settings['lavel_4'] ) : esc_attr__( 'Password Strength: Strong', 'buddyforms' ); ?>" class="" placeholder="<?php esc_attr_e( 'Password Strength: Strong', 'buddyforms' ); ?>">
							</td>
						</tr>
						<tr valign="top">
							<th scope="row" class="titledesc">
							...
							<td class="forminp forminp-text">
								<input name="buddyforms_password_strength_settings[mismatch]" id="buddyforms_password_error" type="text" style="min-width:350px;" value="<?php echo isset( $password_strength_settings['mismatch'] ) && ! empty( $password_strength_settings['mismatch'] ) ? esc_attr( $password_strength_settings['mismatch'] ) : esc_attr__( 'Mismatch', 'buddyforms' ); ?>" class="" placeholder="<?php esc_attr_e( 'Mismatch', 'buddyforms' ); ?>">
							</td>
						<tr valign="top">
							<th scope="row" class="titledesc">
							...
							<td class="forminp forminp-text">
								<input name="buddyforms_password_strength_settings[hint_text]" id="buddyforms_hint_text" type="text" style="min-width:350px;" value="<?php echo isset( $password_strength_settings['hint_text'] ) && ! empty( $password_strength_settings['hint_text'] ) ? esc_attr( $password_strength_settings['hint_text'] ) : esc_attr__( 'Hint: The password should be at least twelve characters long. To make it stronger, use upper and lower case letters, numbers, and symbols like !  ? $ % ^ &amp; ).', 'buddyforms' ); ?>">
							</td>
						</tr>
						</tbody>
					</table>
