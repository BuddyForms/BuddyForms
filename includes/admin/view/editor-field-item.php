...
?>
<li id="field_<?php echo esc_attr( $field_id ); ?>" class="bf_list_item <?php echo esc_attr( $field_id ); ?> bf_<?php echo esc_attr( sanitize_title( $field_type ) ); ?>" data-field_id="<?php echo esc_attr( $field_id ); ?> ">
				...
				<table class="wp-list-table widefat fixed posts tk-editor-field-item-container">
					...
					<tr>
						...
						<td class="field_name tk-editor-field-item-name">
							<div class="tooltip">
								<span class="field_name_text bf-ready-to-copy"><?php echo esc_html( $field_slug ); ?></span>
								<span class="tooltip-container"><?php esc_html_e( 'Copy to clipboard', 'buddyforms' ); ?></span>
							</div>
						</td>
						<td class="field_type tk-editor-field-item-type"><?php echo esc_html( $field_type ); ?></td>
