 ...
 * @since 0.1-beta
 */
function buddyforms_create_contact_us_menu() {

	add_submenu_page( 'edit.php?post_type=buddyforms', __( 'Contact Us', 'buddyforms' ), __( 'Contact Us', 'buddyforms' ), 'manage_options', 'buddyforms_contact_us', 'buddyforms_contact_us_screen' );

}

add_action( 'admin_menu', 'buddyforms_create_contact_us_menu' );

function buddyforms_contact_us_screen() {
