...
function buddyforms_layout_defaults( $form_type = '' ) {
	...
	$json['field_background_color']        = array(
		'color' => '',
		'style' => 'auto',
	);
	$json['field_border_color']            = array(
		'color' => '',
		'style' => 'auto',
	);
	...
	$json['field_font_color']              = array(
		'color' => '',
		'style' => 'auto',
	);
	$json['field_placeholder_font_color']  = array(
		'color' => '',
		'style' => 'auto',
	);
	$json['field_active_background_color'] = array(
		'color' => '',
		'style' => 'auto',
	);
	$json['field_active_border_color']     = array(
		'color' => '',
		'style' => 'auto',
	);
	$json['field_active_font_color']       = array(
		'color' => '',
		'style' => 'auto',
	);
	...
	$json['button_background_color'] = array(
		'color' => '',
		'style' => 'auto',
	);
	$json['button_font_color']       = array(
		'color' => '',
		'style' => 'auto',
	);
	$json['button_border_color']     = array(
		'color' => '',
		'style' => 'auto',
	);

	$json['button_background_color_hover'] = array(
		'color' => '',
		'style' => 'auto',
	);
	$json['button_font_color_hover']       = array(
		'color' => '',
		'style' => 'auto',
	);
	$json['button_border_color_hover']     = array(
		'color' => '',
		'style' => 'auto',
	);
...
function buddyforms_layout_screen( $option_name = 'buddyforms_options' ) {
	...
	$form_setup['Labels'][] = new Element_Checkbox(
		__( 'Disable CSS', 'buddyforms' ),
		$option_name . '[labels_disable_css]',
		array(
	...
	$form_setup['Labels'][] = new Element_Radio(
		'<b>' . __( 'Use labels as placeholders?', 'buddyforms' ) . '</b>',
		$option_name . '[labels_layout]',
		array(
	...
	$form_setup['Labels'][] = new Element_Number(
		'<b>' . __( 'Label Font Size', 'buddyforms' ) . '</b>',
		$option_name . '[label_font_size]',
		array(
	...
	$form_setup['Labels'][] = new Element_Color(
		'<b>' . __( 'Label Font Color', 'buddyforms' ) . '</b>',
		$option_name . '[label_font_color]',
		array(
	...
	$form_setup['Labels'][] = new Element_Radio(
		'<b>' . __( 'Label Font Style', 'buddyforms' ) . '</b>',
		$option_name . '[label_font_style]',
		array(
	...
	$form_setup['Descriptions'][] = new Element_Checkbox(
		'Disable CSS',
		$option_name . '[desc_disable_css]',
		array(
	...
	$form_setup['Descriptions'][] = new Element_Radio(
		'<b>' . __( 'Description Position', 'buddyforms' ) . '</b>',
		$option_name . '[desc_position]',
		array(
	...
	$form_setup['Descriptions'][] = new Element_Number(
		'<b>' . __( 'Description Font Size', 'buddyforms' ) . '</b>',
		$option_name . '[desc_font_size]',
		array(
	...
	$form_setup['Descriptions'][] = new Element_Color(
		'<b>' . __( 'Description Font Color', 'buddyforms' ) . '</b>',
		$option_name . '[desc_font_color]',
		array(
	...
	$form_setup['Descriptions'][] = new Element_Radio(
		'<b>' . __( 'Description Font Style', 'buddyforms' ) . '</b>',
		$option_name . '[desc_font_style]',
		array(
			'normal' => __( 'Normal', 'buddyforms' ),
			'italic' => '<i>' . __( 'Italic', 'buddyforms' ) . '</i>',
		),
	...
	$form_setup['Form Elements'][] = new Element_Checkbox(
		'Disable CSS',
		$option_name . '[other_elements_disable_css]',
		array(
	...
	$form_setup['Form Elements'][] = new Element_Radio(
		'<b>' . __( 'Radio Button Alignment', 'buddyforms' ) . '</b>',
		$option_name . '[radio_button_alignment]',
		array(
	...
	$form_setup['Form Elements'][] = new Element_Radio(
		'<b>' . __( 'Checkbox Option Alignment', 'buddyforms' ) . '</b>',
		$option_name . '[checkbox_alignment]',
		array(
			'inline-block' => __( 'Inline', 'buddyforms' ),
			'block'        => __( 'List', 'buddyforms' ),
		),
	...
	$form_setup['Text Fields'][] = new Element_Checkbox(
		'Disable CSS',
		$option_name . '[field_disable_css]',
		array(
	...
	$form_setup['Text Fields'][] = new Element_Number(
		'<b>' . __( 'Field Padding', 'buddyforms' ) . '</b>',
		$option_name . '[field_padding]',
		array(
			'value'     => $field_padding,
	...
	$form_setup['Text Fields'][] = new Element_Color(
		'<b>' . __( 'Field Background Color ', 'buddyforms' ) . '</b>',
		$option_name . '[field_background_color]',
		array(
	...
	$form_setup['Text Fields'][] = new Element_Color(
		'<b>' . __( 'Field Border Color', 'buddyforms' ) . '</b>',
		$option_name . '[field_border_color]',
		array(
	...
	$form_setup['Text Fields'][] = new Element_Number(
		'<b>' . __( 'Field Border Width', 'buddyforms' ) . '</b>',
		$option_name . '[field_border_width]',
		array(
	...
	$form_setup['Text Fields'][] = new Element_Number(
		'<b>' . __( 'Field Corner Radius', 'buddyforms' ) . '</b>',
		$option_name . '[field_border_radius]',
		array(
	...
	$form_setup['Text Fields'][] = new Element_Number(
		'<b>' . __( 'Field Font Size', 'buddyforms' ) . '</b>',
		$option_name . '[field_font_size]',
		array(
	...
	$form_setup['Text Fields'][] = new Element_Color(
		'<b>' . __( 'Field Font Color', 'buddyforms' ) . '</b>',
		$option_name . '[field_font_color]',
		array(
	...
	$form_setup['Text Fields'][]  = new Element_Color(
		'<b>' . __( 'Field Placeholder Font Color', 'buddyforms' ) . '</b>',
		$option_name . '[field_placeholder_font_color]',
		array(
	...
	$form_setup['Text Fields'][]   = new Element_Color(
		'<b>' . __( 'Field Active Background Color', 'buddyforms' ) . '</b>',
		$option_name . '[field_active_background_color]',
		array(
	...
	$form_setup['Text Fields'][] = new Element_Color(
		'<b>' . __( 'Field Active Border Color', 'buddyforms' ) . '</b>',
		$option_name . '[field_active_border_color]',
		array(
	...
	$form_setup['Text Fields'][] = new Element_Color(
		'<b>' . __( 'Field Active Font Color', 'buddyforms' ) . '</b>',
		$option_name . '[field_active_font_color]',
		array(
	...
	$form_setup['Submit Button'][] = new Element_Checkbox(
		'Disable CSS',
		$option_name . '[button_disable_css]',
		array(
	...
	$form_setup['Submit Button'][] = new Element_Textbox(
		'<b>' . __( 'Button Submit Text', 'buddyforms' ) . '</b>',
		$option_name . '[submit_text]',
		array(
			'value'     => $submit_text,
	...
	$form_setup['Submit Button'][] = new Element_Radio(
		'<b>' . __( 'Button Width', 'buddyforms' ) . '</b>',
		$option_name . '[button_width]',
		array(
	...
	$form_setup['Submit Button'][] = new Element_Radio(
		'<b>' . __( 'Button Alignment', 'buddyforms' ) . '</b>',
		$option_name . '[button_alignment]',
		array(
	...
	$form_setup['Submit Button'][] = new Element_Radio(
		'<b>' . __( 'Button Size', 'buddyforms' ) . '</b>',
		$option_name . '[button_size]',
		array(
	...
	$form_setup['Submit Button'][] = new Element_Textbox(
		'<b>' . __( 'Add custom CSS classes to button', 'buddyforms' ) . '</b>',
		$option_name . '[button_class]',
		array(
			'value'     => $button_class,
	...
	$form_setup['Submit Button'][] = new Element_Number(
		'<b>' . __( 'Button Corner Radius', 'buddyforms' ) . '</b>',
		$option_name . '[button_border_radius]',
		array(
	...
	$form_setup['Submit Button'][] = new Element_Number(
		'<b>' . __( 'Button Border Width', 'buddyforms' ) . '</b>',
		$option_name . '[button_border_width]',
		array(
	...
	$form_setup['Submit Button'][] = new Element_Color(
		'<b>' . __( 'Button Background Color', 'buddyforms' ) . '</b>',
		$option_name . '[button_background_color]',
		array(
	...
	$form_setup['Submit Button'][] = new Element_Color(
		'<b>' . __( 'Button Font Color', 'buddyforms' ) . '</b>',
		$option_name . '[button_font_color]',
		array(
	...
	$form_setup['Submit Button'][] = new Element_Color(
		'<b>' . __( 'Button Border Color', 'buddyforms' ) . '</b>',
		$option_name . '[button_border_color]',
		array(
	...
	$form_setup['Submit Button'][] = new Element_Color(
		'<b>' . __( 'Button Background Color Hover', 'buddyforms' ) . '</b>',
		$option_name . '[button_background_color_hover]',
		array(
	...
	$form_setup['Submit Button'][] = new Element_Color(
		'<b>' . __( 'Button Font Color Hover', 'buddyforms' ) . '</b>',
		$option_name . '[button_font_color_hover]',
		array(
	...
	$form_setup['Submit Button'][] = new Element_Color(
		'<b>' . __( 'Button Border Color Hover', 'buddyforms' ) . '</b>',
		$option_name . '[button_border_color_hover]',
		array(
	...
	$form_setup['Custom CSS'][] = new Element_Textarea(
		'<b>' . __( 'Custom CSS', 'buddyforms' ) . '</b>',
	...
	$form_setup['Extras'][] = new Element_Checkbox(
		'Disable all CSS',
		$option_name . '[extras_disable_all_css]',
		array(
	...
	if ( get_post_type() == 'buddyforms' ) {
		...
		if ( isset( $buddyforms ) ) {
			foreach ( $buddyforms as $form_slug => $form ) {
				echo '<option value="' . esc_attr( $form_slug ) . '">' . esc_html( $form['name'] ) . '</option>';
			}
		}
		echo '</select>';
	...
	<div class="tabbable buddyform-tabs-left">
		<ul class="nav buddyform-nav-tabs buddyform-nav-pills">
			...
			foreach ( $form_setup as $tab => $fields ) {
				...
				?>
			<li class="<?php echo $i == 0 ? 'active' : ''; ?><?php echo esc_attr( $tab_slug ); ?>_nav"><a
						href="#<?php echo esc_attr( $tab_slug ); ?>"
						data-toggle="tab"><?php echo wp_kses( $tab, buddyforms_wp_kses_allowed_atts() ); ?></a>
				</li>
				<?php
				$i ++;
			}
							...
							foreach ( $fields as $field_key => $field ) {
								...
								if ( $type != 'html' ) {
									...
									<tr class="<?php echo esc_attr( $classes ); ?>">
										<th scope="row">
											<label for="form_title"><?php echo wp_kses( $field->getLabel(), buddyforms_wp_kses_allowed_atts() ); ?></label>
										</th>
										<td>
