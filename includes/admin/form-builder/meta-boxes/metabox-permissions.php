	...
	<div class="fields_header">
		<table class="wp-list-table widefat posts striped bf_permissions">
			...
			<tr>
				...
				<th class="field_name">
					<?php echo sprintf( '<span class="bf-permissions-header-1">%s</span>', esc_html__( 'Create', 'buddyforms' ) ); ?>
					<?php echo sprintf( '<span class="bf-permissions-header-2">%s</span>', esc_html__( 'Edit', 'buddyforms' ) ); ?>
					<?php echo sprintf( '<span class="bf-permissions-header-2">%s</span>', esc_html__( 'Delete', 'buddyforms' ) ); ?>
					<?php echo sprintf( '<span class="bf-permissions-header-2">%s</span>', esc_html__( 'Draft', 'buddyforms' ) ); ?>
					<?php echo sprintf( '<span class="bf-permissions-header-2">%s</span>', esc_html__( 'All Submissions', 'buddyforms' ) ); ?>
					<?php echo sprintf( '<span class="bf-permissions-header-2">%s</span>', esc_html__( 'Admin Submission', 'buddyforms' ) ); ?>
					<?php if ( buddyforms_core_fs()->is_paying_or_trial() ) : ?>
						<a style="float: right;" href="#" class="bf_check_all"><?php esc_html_e( 'Check all', 'buddyforms' ); ?></a>
					<?php endif; ?>
				</th>
			</tr>
			</thead>
