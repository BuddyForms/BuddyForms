							...
							<td class="field_label">
								<strong>
									<a class="bf_edit_field row-title accordion-toggle collapsed" data-toggle="collapse"
									   ...
									   href="#"><?php echo isset( $buddyform['mail_submissions'][ $trigger ]['mail_subject'] ) ? esc_html( $buddyform['mail_submissions'][ $trigger ]['mail_subject'] ) : ''; ?></a>
								</strong>
						...
						<tr>
							...
							<td class="field_label">
								<strong>
									<a class="bf_edit_field row-title accordion-toggle collapsed" data-toggle="collapse"
									   data-parent="#accordion_text" href="#accordion_<?php echo esc_attr( $trigger ); ?>"
									   title="Edit this Notification" href="#"><?php echo esc_attr( $trigger ); ?></a>
								</strong>
