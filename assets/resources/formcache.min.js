...
!function (a) {
    ...
    "use strict";
    var b = a(window), c = window.sessionStorage, d = window.localStorage, e = "undefined", f = ".formcache", g = /[\.\*\+\^\$\:\!\[\]#>~]+/g, h = "change" + f, i = "beforeunload" + f, j = function (a) {
        return "checkbox" === a.type || "radio" === a.type
    }, k = function (a) {
        return parseInt(a, 10)
    }, l = function (b, c) {
        this.form = b, this.$form = a(b), this.defaults = a.extend({}, l.DEFAULTS, a.isPlainObject(c) ? c : {}), this.init()
    };
    l.prototype = {
        constructor: l, init: function () {
            var b = this.defaults;
            b.maxAge = Math.abs(b.maxAge || b.maxage), b.autoStore = Boolean(b.autoStore || b.autostore), this.initKey(), this.initStorage(), this.caches = this.storage.caches, this.index = 0, this.activeIndex = 0, this.storing = null, a.isArray(b.controls) || (b.controls = []), this.$controls = this.$form.find(b.controls.join()).not(":file"), this.addListeners(), this.outputCache()
        }, initKey: function () {
            var b = this.$form, c = this.defaults.key || b.data("key");
            c || (a("form").each(function (b) {
                a(this).data("key", b)
            }), c = b.data("key")), this.key = location.pathname + "#formcache-" + c
        }, initStorage: function () {
            var b, e = this.defaults, f = this.key, g = new Date, h = {date: g, maxAge: e.maxAge, caches: []};
            c && (b = c.getItem(f)), !b && d && (b = d.getItem(f)), b = "string" == typeof b ? JSON.parse(b) : null, a.isPlainObject(b) ? "number" == typeof b.maxAge && (g - new Date(b.date)) / 1e3 > b.maxAge && (b = h) : b = h, this.storage = b
            ...
            var c, d, e = b.target, f = a(e), h = f.attr("name"), i = [];
            ...
            typeof c === e && (c = b, b = 0 / 0), a.isPlainObject(c) && (b = k(b) || this.index, this.caches[b] = c, this.store())
            ...
            a.isPlainObject(c) && (this.activeIndex = k(b) || this.index, c = a.extend(!0, {}, c), this.$controls.each(function () {
                var b, d, e = a(this), f = e.attr("name");
                f && (b = c[f], a.isArray(b) && b.length && (d = b.shift(), j(this) ? this.checked = d : e.val(d)))
            }))
        }, store: function () {
            var a = this.storage, b = this.key, e = this.defaults;
            a.date = new Date, a.maxAge = e.maxAge, a = JSON.stringify(a), e.session && c && c.setItem(b, a), e.local && d && d.setItem(b, a)
        }, clear: function () {
            var a = this.key, b = this.defaults;
        ...
        return this.each(function () {
            var e, f = a(this), g = f.data("formcache");
            g || f.data("formcache", g = new l(this, b)), "string" == typeof b && a.isFunction(e = g[b]) && (c = e.apply(g, d))
        }), typeof c !== e ? c : this
    }, a.fn.formcache.Constructor = l, a.fn.formcache.setDefaults = l.setDefaults, a.fn.formcache.noConflict = function () {
