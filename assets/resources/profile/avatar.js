    ...
    bp.Views.Avatar = bp.View.extend( {
        ...
        showPreview: function( coords ) {
            ...
            if ( parseInt( coords.w, 10 ) > 0 ) {
                ...
                cropWidth = Math.round( rx *  this.model.get( 'width' ) );
                cropheigth = Math.round( ry * this.model.get( 'height' ) );
                cropMarginLeft = Math.round( rx * this.model.get( 'x' ) );
                cropMarginTop =  Math.round( ry * this.model.get( 'y' ) );
