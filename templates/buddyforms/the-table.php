...
<!--                            <span class="mobile-th">--><?php // _e( 'Title', 'buddyforms' ); ?><!--</span>-->
							<a class="<?php echo $post_type === 'bf_submissions' ? 'bf-submission-modal' : ''; ?> "
							   data-id="<?php the_ID(); ?>" href="<?php echo esc_url( $the_permalink ); ?>" rel="bookmark"
							   title="<?php esc_html_e( 'Permanent Link to', 'buddyforms' ); ?> <?php the_title_attribute(); ?>"><?php echo esc_url( $the_title ); ?></a>
