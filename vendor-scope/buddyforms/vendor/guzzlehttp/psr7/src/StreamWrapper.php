...
class StreamWrapper
{
     ...
     */
    public static function getResource(\tk\Psr\Http\Message\StreamInterface $stream)
    {
        self::register();
     ...
     * @return resource
     */
    public static function createStreamContext(\tk\Psr\Http\Message\StreamInterface $stream)
    {
