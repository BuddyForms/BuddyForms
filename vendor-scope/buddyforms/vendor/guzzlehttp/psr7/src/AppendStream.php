 ...
 */
class AppendStream implements \tk\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function addStream(\tk\Psr\Http\Message\StreamInterface $stream)
    {
    ...
    {
        return \tk\GuzzleHttp\Psr7\Utils::copyToString($this);
    }
    /**
