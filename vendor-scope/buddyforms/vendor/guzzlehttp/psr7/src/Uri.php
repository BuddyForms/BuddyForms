 ...
 */
class Uri implements \tk\Psr\Http\Message\UriInterface
{
    /**
     ...
     * @return bool
     */
    public static function isDefaultPort(\tk\Psr\Http\Message\UriInterface $uri)
    {
     ...
     */
    public static function isAbsolute(\tk\Psr\Http\Message\UriInterface $uri)
    {
     ...
     */
    public static function isNetworkPathReference(\tk\Psr\Http\Message\UriInterface $uri)
    {
     ...
     * @link https://tools.ietf.org/html/rfc3986#section-4.2
     */
    public static function isAbsolutePathReference(\tk\Psr\Http\Message\UriInterface $uri)
    {
     ...
     * @link https://tools.ietf.org/html/rfc3986#section-4.2
     */
    public static function isRelativePathReference(\tk\Psr\Http\Message\UriInterface $uri)
    {
        return $uri->getScheme() === '' && $uri->getAuthority() === '' && (!isset($uri->getPath()[0]) || $uri->getPath()[0] !== '/');
    }
    /**
     ...
     */
    public static function isSameDocumentReference(\tk\Psr\Http\Message\UriInterface $uri, \tk\Psr\Http\Message\UriInterface $base = null)
    {
        if ($base !== null) {
            $uri = \tk\GuzzleHttp\Psr7\UriResolver::resolve($base, $uri);
    ...
    {
        return \tk\GuzzleHttp\Psr7\UriResolver::removeDotSegments($path);
    }
    /**
     ...
     */
    public static function resolve(\tk\Psr\Http\Message\UriInterface $base, $rel)
    {
        if (!$rel instanceof \tk\Psr\Http\Message\UriInterface) {
            $rel = new self($rel);
        }
        return \tk\GuzzleHttp\Psr7\UriResolver::resolve($base, $rel);
    }
    /**
     ...
     * @return UriInterface
     */
    public static function withoutQueryValue(\tk\Psr\Http\Message\UriInterface $uri, $key)
    {
     ...
     * @return UriInterface
     */
    public static function withQueryValue(\tk\Psr\Http\Message\UriInterface $uri, $key, $value)
    {
        $result = self::getFilteredQueryString($uri, [$key]);
     ...
     * @return UriInterface
     */
    public static function withQueryValues(\tk\Psr\Http\Message\UriInterface $uri, array $keyValueArray)
    {
     ...
     * @return array
     */
    private static function getFilteredQueryString(\tk\Psr\Http\Message\UriInterface $uri, array $keys)
    {
