 ...
 */
function str(\tk\Psr\Http\Message\MessageInterface $message)
{
    return \tk\GuzzleHttp\Psr7\Message::toString($message);
}
/**
...
{
    return \tk\GuzzleHttp\Psr7\Utils::uriFor($uri);
}
/**
...
{
    return \tk\GuzzleHttp\Psr7\Utils::streamFor($resource, $options);
}
/**
...
{
    return \tk\GuzzleHttp\Psr7\Header::parse($header);
}
/**
...
{
    return \tk\GuzzleHttp\Psr7\Header::normalize($header);
}
/**
 ...
 */
function modify_request(\tk\Psr\Http\Message\RequestInterface $request, array $changes)
{
    return \tk\GuzzleHttp\Psr7\Utils::modifyRequest($request, $changes);
}
/**
 ...
 */
function rewind_body(\tk\Psr\Http\Message\MessageInterface $message)
{
    \tk\GuzzleHttp\Psr7\Message::rewindBody($message);
}
/**
...
{
    return \tk\GuzzleHttp\Psr7\Utils::tryFopen($filename, $mode);
}
/**
 ...
 */
function copy_to_string(\tk\Psr\Http\Message\StreamInterface $stream, $maxLen = -1)
{
    return \tk\GuzzleHttp\Psr7\Utils::copyToString($stream, $maxLen);
}
/**
 ...
 */
function copy_to_stream(\tk\Psr\Http\Message\StreamInterface $source, \tk\Psr\Http\Message\StreamInterface $dest, $maxLen = -1)
{
    return \tk\GuzzleHttp\Psr7\Utils::copyToStream($source, $dest, $maxLen);
}
/**
 ...
 */
function hash(\tk\Psr\Http\Message\StreamInterface $stream, $algo, $rawOutput = \false)
{
    return \tk\GuzzleHttp\Psr7\Utils::hash($stream, $algo, $rawOutput);
}
/**
 ...
 */
function readline(\tk\Psr\Http\Message\StreamInterface $stream, $maxLength = null)
{
    return \tk\GuzzleHttp\Psr7\Utils::readLine($stream, $maxLength);
}
/**
...
{
    return \tk\GuzzleHttp\Psr7\Message::parseRequest($message);
}
/**
...
{
    return \tk\GuzzleHttp\Psr7\Message::parseResponse($message);
}
/**
...
{
    return \tk\GuzzleHttp\Psr7\Query::parse($str, $urlEncoding);
}
/**
...
{
    return \tk\GuzzleHttp\Psr7\Query::build($params, $encoding);
}
/**
...
{
    return \tk\GuzzleHttp\Psr7\MimeType::fromFilename($filename);
}
/**
...
{
    return \tk\GuzzleHttp\Psr7\MimeType::fromExtension($extension);
}
/**
...
{
    return \tk\GuzzleHttp\Psr7\Message::parseMessage($message);
}
/**
...
{
    return \tk\GuzzleHttp\Psr7\Message::parseRequestUri($path, $headers);
}
/**
 ...
 */
function get_message_body_summary(\tk\Psr\Http\Message\MessageInterface $message, $truncateAt = 120)
{
    return \tk\GuzzleHttp\Psr7\Message::bodySummary($message, $truncateAt);
}
/**
...
{
    return \tk\GuzzleHttp\Psr7\Utils::caselessRemove($keys, $data);
}
