...
class RetryMiddleware
{
     ...
     */
    private function onFulfilled(\tk\Psr\Http\Message\RequestInterface $request, array $options) : callable
    {
     ...
     */
    private function onRejected(\tk\Psr\Http\Message\RequestInterface $req, array $options) : callable
    {
    ...
    private function doRetry(\tk\Psr\Http\Message\RequestInterface $request, array $options, \tk\Psr\Http\Message\ResponseInterface $response = null) : \tk\GuzzleHttp\Promise\PromiseInterface
    {
