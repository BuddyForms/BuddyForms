...
use tk\GuzzleHttp\Psr7\Response;
...
final class EasyHandle
{
    ...
    public function createResponse() : void
    {
        ...
        $headers = \tk\GuzzleHttp\Utils::headersFromLines($this->headers);
        ...
        $this->response = new \tk\GuzzleHttp\Psr7\Response($statusCode, $headers, $this->sink, \substr($startLine[0], 5), isset($startLine[2]) ? (string) $startLine[2] : null);
    }
    /**
     * @param string $name
     *
